...
In Figure \ref{fig:twz-feynamn}, the Leading Order (LO) Feynman diagram for $tWZ$ in the tetralepton channel, is shown.

\begin{figure}[h]
\includegraphics[width=12pc]{4lep_feynman.png}
\includegraphics[width=12pc]{3lep_feynman.png}
