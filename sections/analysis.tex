...
In Table~\ref{tab:iff-breakdown}, the number of leptons, by their IFF Truth classification, in each region for the $t\bar{t}Z$ and $t\bar{t}Z$ fake backgrounds are shown.

\begin{table}[h!]

\begin{tabular}{llllll}
\hline
\multicolumn{1}{l|}{}                                & \multicolumn{1}{l|}{$tWZ$ OF SR} & \multicolumn{1}{l|}{$tWZ$ SF SR} & \multicolumn{1}{l|}{$t\bar{t}Z$ CR} & \multicolumn{1}{l|}{$ZZb$ CR} & $(tWZ)_{\text{fake}}$ CR \\ \hline
\multicolumn{6}{c}{$t\bar{t}Z$ background}                                                                                                                                                                  \\ \hline
\multicolumn{1}{l|}{\texttt{Unknown}}                & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 0             \\
\multicolumn{1}{l|}{\texttt{KnownUnknown}}           & \multicolumn{1}{l|}{2}     & \multicolumn{1}{l|}{3}     & \multicolumn{1}{l|}{7}         & \multicolumn{1}{l|}{0}         & 18            \\
\multicolumn{1}{l|}{\texttt{IsoElectron}}            & \multicolumn{1}{l|}{10906} & \multicolumn{1}{l|}{6495}  & \multicolumn{1}{l|}{22828}     & \multicolumn{1}{l|}{3362}      & 17737         \\
\multicolumn{1}{l|}{\texttt{ChargeFlipIsoElectron}}  & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{1}     & \multicolumn{1}{l|}{3}         & \multicolumn{1}{l|}{2}         & 3             \\
\multicolumn{1}{l|}{\texttt{PromptMuon}}             & \multicolumn{1}{l|}{12863} & \multicolumn{1}{l|}{10273} & \multicolumn{1}{l|}{30434}     & \multicolumn{1}{l|}{5272}      & 18112         \\
\multicolumn{1}{l|}{\texttt{PromptPhotonConversion}} & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 1             \\
\multicolumn{1}{l|}{\texttt{ElectronFromMuon}}       & \multicolumn{1}{l|}{1}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 9             \\
\multicolumn{1}{l|}{\texttt{TauDecay}}               & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 51            \\
\multicolumn{1}{l|}{\texttt{BHadronDecay}}           & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 4             \\
\multicolumn{1}{l|}{\texttt{CHadronDecay}}           & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 3             \\
\multicolumn{1}{l|}{\texttt{LightFlavourDecay}}      & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 2             \\ \hline
\multicolumn{6}{c}{$t\bar{t}Z$ fake background}                                                                                                                                                                     \\ \hline
\multicolumn{1}{l|}{\texttt{Unknown}}                & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 0             \\
\multicolumn{1}{l|}{\texttt{KnownUnknown}}           & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 2             \\
\multicolumn{1}{l|}{\texttt{IsoElectron}}            & \multicolumn{1}{l|}{47}    & \multicolumn{1}{l|}{26}    & \multicolumn{1}{l|}{48}        & \multicolumn{1}{l|}{15}        & 2887          \\
\multicolumn{1}{l|}{\texttt{ChargeFlipIsoElectron}}  & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 1             \\
\multicolumn{1}{l|}{\texttt{PromptMuon}}             & \multicolumn{1}{l|}{82}    & \multicolumn{1}{l|}{31}    & \multicolumn{1}{l|}{69}        & \multicolumn{1}{l|}{27}        & 3878          \\
\multicolumn{1}{l|}{\texttt{PromptPhotonConversion}} & \multicolumn{1}{l|}{4}     & \multicolumn{1}{l|}{4}     & \multicolumn{1}{l|}{12}        & \multicolumn{1}{l|}{0}         & 18            \\
\multicolumn{1}{l|}{\texttt{ElectronFromMuon}}       & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 0             \\
\multicolumn{1}{l|}{\texttt{TauDecay}}               & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}     & \multicolumn{1}{l|}{0}         & \multicolumn{1}{l|}{0}         & 0             \\
\multicolumn{1}{l|}{\texttt{BHadronDecay}}           & \multicolumn{1}{l|}{26}    & \multicolumn{1}{l|}{10}    & \multicolumn{1}{l|}{10}        & \multicolumn{1}{l|}{9}         & 1593          \\
\multicolumn{1}{l|}{\texttt{CHadronDecay}}           & \multicolumn{1}{l|}{5}     & \multicolumn{1}{l|}{2}     & \multicolumn{1}{l|}{6}         & \multicolumn{1}{l|}{4}         & 345           \\
\multicolumn{1}{l|}{\texttt{LightFlavourDecay}}      & \multicolumn{1}{l|}{8}     & \multicolumn{1}{l|}{3}     & \multicolumn{1}{l|}{11}        & \multicolumn{1}{l|}{1}         & 300           \\ \hline
\end{tabular}
\centering
\label{tab:iff-breakdown}
\caption{The number of leptons, by their IFF Truth classification, in each region for the $t\bar{t}Z$ and $t\bar{t}Z$ fake backgrounds are shown.}
\end{table}
...
In Figure~\ref{fig:4lep-ttZCR-eventbdt-var}, MC predictions for the input variables to the event-level BDT in the $t\bar{t}Z$ CR are shown.
\begin{figure}[htbp]
\centering
...
In Figure~\ref{fig:4lep-ZZbCR-eventbdt-var}, MC predictions for the input variables to the event-level BDT in the $ZZb$ CR are shown.
\begin{figure}[htbp]
\centering
