...
In Figure~\ref{fig:4lep-ttZCR-objectbdt-var}, MC predictions for the input variables to the object-level BDT in the $t\bar{t}Z$ CR are shown.
\begin{figure}[htbp]
\centering
