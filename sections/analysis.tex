...
In Figure \ref{fig:norm-object-bdt-vars}, normalised distributions of the signal and background classes for the training set of all variables used in the object-level BDT are shown.
