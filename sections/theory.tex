...
In Figure~\ref{fig:twzfourlep_FeymanDiagram}, the Leading Order (LO) Feynman diagram for \tWZ in the tetra-lepton channel, is shown.
...
\end{tikzpicture}
\caption{The LO Feynman diagram of \tWZ production in the tetra-lepton channel is shown.}
...
\captionof{figure}{LO Feynman diagrams for \ttZ (left) and \ZZ (right) in the tetralepton channel are shown.}  %minipage 'figure' caption\\\\
