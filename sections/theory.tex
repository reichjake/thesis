...
The Standard Model (SM) is a Quantum Field Theory (QFT) which classifies all known elementary particles and describes their interactions. It is a well-tested model and has shown to be hugely successful in describing experimental data to great precision. It incorporates three of the four fundamental forces of nature: the electromagnetic, the weak and the strong forces.\\\\
In Figure~\ref{fig:SM-particles}, all known elementary particles predicted by the SM, are shown.


\begin{figure}[h!]
 \includegraphics[width=0.5\textwidth]{figures/theoryFigs/SM_particles.png}
\caption{Schematic of the ATLAS detector~\cite{Collaboration_2008}}
\centering
\label{fig:SM-particles}
\end{figure}

SM particles are uniquely described by their quantum numbers: mass, electric charge, colour charge and spin.



The SM particles are split into main two classes. Particles which have half-integer spin are called fermions, and those which have integer spin are called bosons. Fermions are able to interact with one-another via the exchange of a gauge boson (boson with spin-0).


All particles described in the SM have their own antiparticle. 

Fermions can be further classified as quarks and leptons.
