...
\begin{center}
	\begin{minipage}{0.75\linewidth}
		...
		\vspace{3cm}
		%Thesis title
		{{\Large A search for $tWZ$ production in the Full Run 2 ATLAS dataset using events with four leptons.\par}}
		\vspace{3cm}
		%Author's name
...
\chapter{The search for $tWZ$ production in the Full Run 2 ATLAS dataset using events with four leptons}
